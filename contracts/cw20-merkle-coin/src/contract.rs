...
use cosmwasm_std::{attr, to_binary, Addr, Binary, Deps, DepsMut, Env, MessageInfo, Response, StdResult, Uint128, WasmMsg, BankMsg, Coin};
...
pub fn execute_claim(
    ...
    let res = Response::new()
        .add_message(BankMsg::Send {
            ...
            amount: vec![Coin::new(amount.u128(), config.denom)]
        })
        .add_attributes(vec![
            attr("action", "claim"),
            attr("stage", stage.to_string()),
...
mod tests {
    ...
    fn claim() {
        ...
        let expected = BankMsg::Send {
            to_address: test_data.account.clone(),
            amount: vec![Coin::new(test_data.amount.u128(), "uluna".to_string())]
        };
